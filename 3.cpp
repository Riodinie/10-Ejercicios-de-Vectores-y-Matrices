/*3.	Crear una matriz de 5×7, donde 5 representan la semana de un mes y 7 los días de la semana
...
int main(){
	...
	for(int i=0; i<5; i++){
		tempMax = 0; tempMin = 38; diaMax=0; diaMin=0; tempPromedio = 0;
		for(int j=0; j<7; j++){
		...
		if(ultima){
			cout<<"tempPromedio: "<<tempPromedio/3<<endl<<endl;
		}else{
			cout<<"tempPromedio: "<<tempPromedio/7<<endl<<endl;
		}
	}
